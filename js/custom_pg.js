...
// Le time value
var end = new Date('06/30/2016 08:00 AM');
...
function showRemaining() {
    ...
    // Le style
    document.getElementById('countdown').innerHTML = '<div class="col-sm-2 col-sm-offset-2">' + days + '<span>days</span></div>';
    document.getElementById('countdown').innerHTML += '<div class="col-sm-2">' + hours + '<span>hours</span></div>';
    document.getElementById('countdown').innerHTML += '<div class="col-sm-2">' + minutes + '<span>minutes</span></div>';
    document.getElementById('countdown').innerHTML += '<div class="col-sm-2"><div class="animated fadeIn">' + seconds + '</div><span>seconds</span></div>';
}

timer = setInterval(showRemaining, 1000);

$('document').ready(function() {
	$('#emailAddr').html('<a href=\"mailto:OpenTheGate@platinumgate.consulting?subject=PlatinumGATE Website Inquiry\">OpenTheGate@platinumgate.consulting</a>');
});